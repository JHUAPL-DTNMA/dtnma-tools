...
// ari:/AC/(/TBL/c=3;(1,2,3)(4,5,6),//1/1/OPER/tbl-filter(/AC/(true),/AC/(0,1,2))) -> /TBL/c=3;(1,2,3)(4,5,6)
TEST_CASE("82118282138703010203040506850101256A74626C2D66696C74657282821181F5821183000102", "82138703010203040506")

// ari:/AC/(/TBL/c=3;(1,2,3)(4,5,6),//1/1/OPER/tbl-filter(/AC/(true),/AC/(1,2,3))) -> undefined -- fails because invalid filter index!!
TEST_CASE("82118282138703010203040506850101256A74626C2D66696C74657282821181F5821183010203", "F7")

// ari:/AC/(/TBL/c=2;(0,0)(1,1)(2,2)(3,3),//1/1/OPER/tbl-filter(/AC/(0,/LABEL/0,//1/1/OPER/compare-gt),/AC/(1))) -> /TBL/c=1;(1)(2)(3)
TEST_CASE("821182821389020000010102020303850101256A74626C2D66696C7465728282118300820E00840101256A636F6D706172652D677482118101", "82138401010203")
