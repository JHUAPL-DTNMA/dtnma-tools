...
//
//// ari:/AC/(/INT/5,/INT/0xF,//1/OPER/bit-and) -> /INT/5
//TEST_CASE("82118382040582040F830125676269742D616E64", "820405")
//// ari:/AC/(/INT/5,/UVAST/0xF,//1/OPER/bit-and) -> /VAST/5
//TEST_CASE("82118382040582070F830125676269742D616E64", "820605")
//
//// ari:/AC/(/INT/5,/INT/0xF,//1/OPER/bit-or) -> /INT/15
//TEST_CASE("82118382040582040F830125666269742D6F72", "82040F")
//// ari:/AC/(/INT/5,/UVAST/0xF,//1/OPER/bit-or) -> /VAST/15
//TEST_CASE("82118382040582070F830125666269742D6F72", "82060F")
//
//// ari:/AC/(/INT/5,/INT/0xF,//1/OPER/bit-xor) -> /INT/10
//TEST_CASE("82118382040582040F830125676269742D786F72", "82040A")
//// ari:/AC/(/INT/5,/UVAST/0xF,//1/OPER/bit-xor) -> /VAST/10
//TEST_CASE("82118382040582070F830125676269742D786F72", "82060A")
//
//// ari:/AC/(/INT/0xF,//1/OPER/bit-not) -> /INT/0xFFFFFFF0
//TEST_CASE("82118282040F830125676269742D6E6F74", "82042F")
//// FIXME:
...
// ari:/AC/(/REAL64/32,/UVAST/16,//1/OPER/add) -> /REAL64/48
TEST_CASE("8211838209F9500082071083012563616464", "8209F95200")

// ari:/AC/(/INT/0x1,/UVAST/16,//1/OPER/sub) -> /VAST/15
TEST_CASE("82118382040182071083012563737562", "82060F")
// ari:/AC/(/INT/0x1,/UVAST/16,//1/OPER/multiply) -> /VAST/16
TEST_CASE("821183820401820710830125686D756C7469706C79", "820610")
// ari:/AC/(/INT/0x10,/UVAST/1,//1/OPER/divide) -> /VAST/0
TEST_CASE("82118382041082070183012566646976696465", "820600")

// ari:/AC/(/INT/0x10,/UVAST/1,//1/OPER/remainder) -> /VAST/1
TEST_CASE("8211838204108207018301256972656D61696E646572", "820601")
// ari:/AC/(/INT/3,/UVAST/7,//1/OPER/remainder) -> /VAST/1
TEST_CASE("8211838204038207078301256972656D61696E646572", "820601")

// ari:/AC/(/INT/3,//1/OPER/negate) -> /INT/-3
TEST_CASE("821182820403830125666E6567617465", "820422")
// ari:/AC/(/UINT/3,//1/OPER/negate) -> /INT/-3
TEST_CASE("821182820503830125666E6567617465", "820422")
// ari:/AC/(/REAL32/3,//1/OPER/negate) -> /REAL32/-3
TEST_CASE("8211828208F94200830125666E6567617465", "8208F9C200")

// ari:/AC/(/INT/2,/INT/2,//1/OPER/compare-eq) -> /BOOL/true
TEST_CASE("8211838204028204028301256A636F6D706172652D6571", "8201F5")
// ari:/AC/(/INT/2,/INT/3,//1/OPER/compare-ne) -> /BOOL/true
TEST_CASE("8211838204028204038301256A636F6D706172652D6E65", "8201F5")
...
//FIXME: need to add builtin_float32_convert in typing.c TEST_CASE("8211838208F940008206182E8301256A636F6D706172652D6774", "8201F5")
