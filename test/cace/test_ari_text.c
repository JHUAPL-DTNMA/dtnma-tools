...
TEST_CASE("ari://test/LITERAL/hi", ARI_TYPE_LITERAL)
TEST_CASE("ari://test/NULL/hi", ARI_TYPE_NULL)
TEST_CASE("ari://test/BOOL/hi", ARI_TYPE_BOOL)
TEST_CASE("ari://test/BYTE/hi", ARI_TYPE_BYTE)
TEST_CASE("ari://test/INT/hi", ARI_TYPE_INT)
TEST_CASE("ari://test/UINT/hi", ARI_TYPE_UINT)
TEST_CASE("ari://test/VAST/hi", ARI_TYPE_VAST)
TEST_CASE("ari://test/UVAST/hi", ARI_TYPE_UVAST)
TEST_CASE("ari://test/REAL32/hi", ARI_TYPE_REAL32)
TEST_CASE("ari://test/REAL64/hi", ARI_TYPE_REAL64)
TEST_CASE("ari://test/TEXTSTR/hi", ARI_TYPE_TEXTSTR)
TEST_CASE("ari://test/BYTESTR/hi", ARI_TYPE_BYTESTR)
TEST_CASE("ari://test/TP/hi", ARI_TYPE_TP)
TEST_CASE("ari://test/TD/hi", ARI_TYPE_TD)
TEST_CASE("ari://test/LABEL/hi", ARI_TYPE_LABEL)
TEST_CASE("ari://test/CBOR/hi", ARI_TYPE_CBOR)
TEST_CASE("ari://test/ARITYPE/hi", ARI_TYPE_ARITYPE)
TEST_CASE("ari://test/AC/hi", ARI_TYPE_AC)
TEST_CASE("ari://test/AM/hi", ARI_TYPE_AM)
TEST_CASE("ari://test/TBL/hi", ARI_TYPE_TBL)
TEST_CASE("ari://test/EXECSET/hi", ARI_TYPE_EXECSET)
TEST_CASE("ari://test/RPTSET/hi", ARI_TYPE_RPTSET)
TEST_CASE("ari://test/OBJECT/hi", ARI_TYPE_OBJECT)
