...
/** Require a CBOR item to have a floating-point value.
 * @note The return type is always the maximum-width @c double regardless
 * of the encoded type.
 *
 * @param alloc The allocator to use.
 * @param[in,out] chunk The chunk to read from and write errors on.
 * @return Pointer to the value, if the item was an floating point value.
 */
WS_DLL_PUBLIC
