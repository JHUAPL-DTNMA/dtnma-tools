...
CREATE OR REPLACE VIEW vw_tblt_actual AS
    ...
    FROM
        ...
        JOIN table_template_actual_definition ON obj_actual_definition.obj_actual_definition_id = table_template_actual_definition.obj_actual_definition_id) AS view1 ON 
