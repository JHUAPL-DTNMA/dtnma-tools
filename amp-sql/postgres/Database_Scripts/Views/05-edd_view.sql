...
CREATE OR REPLACE VIEW vw_edd_actual AS
    ...
    FROM
        ...
        JOIN edd_actual_definition ON obj_actual_definition.obj_actual_definition_id = edd_actual_definition.obj_actual_definition_id) AS view1 ON view1.obj_metadata_id = obj_formal_definition.obj_metadata_id) join2 ON join2.obj_metadata_id = obj_metadata.obj_metadata_id;