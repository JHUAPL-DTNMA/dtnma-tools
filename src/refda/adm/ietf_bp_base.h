...
#define REFDA_ADM_IETF_BP_BASE_ORG_NAME "ietf"
/// Enumeration of the organization
#define REFDA_ADM_IETF_BP_BASE_ORG_ENUM 1
/// Text name of the model
#define REFDA_ADM_IETF_BP_BASE_MODEL_NAME "bp-base"
/// Enumeration of the model
#define REFDA_ADM_IETF_BP_BASE_MODEL_ENUM 5
/// Revision date for the model
#define REFDA_ADM_IETF_BP_BASE_MODEL_REVISION "2026-04-02"
/// @deprecated use REFDA_ADM_IETF_BP_BASE_MODEL_ENUM directly
#define REFDA_ADM_IETF_BP_BASE_ENUM_ADM REFDA_ADM_IETF_BP_BASE_MODEL_ENUM
