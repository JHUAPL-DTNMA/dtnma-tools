...
int refda_adm_iana_display_hints_init(refda_agent_t *agent)
{
    ...
    cace_amm_obj_ns_t *adm = cace_amm_obj_store_add_ns(&(agent->objs), "iana-display-hints", "2024-07-20", true,
                                                       REFDA_ADM_IANA_DISPLAY_HINTS_ENUM_ADM);
    if (adm)
    {
        ...
        { // For ./IDENT/base-integer
            ...
            // IDENT bases:
            {
                ...
                ari_set_objref_path_intid(&(base->name), 0, ARI_TYPE_IDENT, 0);
            }

            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("base-integer", REFDA_ADM_IANA_DISPLAY_HINTS_ENUM_OBJID_IDENT_BASE_INTEGER),
                objdata);
            // no parameters
        }
        { // For ./IDENT/display-int-dec
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-int-dec",
        ...
        { // For ./IDENT/display-int-bin
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-int-bin",
        ...
        { // For ./IDENT/display-int-hex
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-int-hex",
        ...
        { // For ./IDENT/base-float
            ...
            obj = refda_register_ident(
                adm, cace_amm_obj_id_withenum("base-float", REFDA_ADM_IANA_DISPLAY_HINTS_ENUM_OBJID_IDENT_BASE_FLOAT),
                objdata);
            // no parameters
        }
        { // For ./IDENT/display-float-dec
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-float-dec",
        ...
        { // For ./IDENT/display-float-exp
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-float-exp",
        ...
        { // For ./IDENT/display-float-hex
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-float-hex",
        ...
        { // For ./IDENT/base-bstr
            ...
            obj = refda_register_ident(
                adm, cace_amm_obj_id_withenum("base-bstr", REFDA_ADM_IANA_DISPLAY_HINTS_ENUM_OBJID_IDENT_BASE_BSTR),
                objdata);
            // no parameters
        }
        { // For ./IDENT/display-bstr-text
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-bstr-text",
        ...
        { // For ./IDENT/display-bstr-base16
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-bstr-base16",
        ...
        { // For ./IDENT/display-bstr-base64
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-bstr-base64",
        ...
        { // For ./IDENT/display-bstr-ipaddress
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-bstr-ipaddress",
        ...
        { // For ./IDENT/base-time
            ...
            obj = refda_register_ident(
                adm, cace_amm_obj_id_withenum("base-time", REFDA_ADM_IANA_DISPLAY_HINTS_ENUM_OBJID_IDENT_BASE_TIME),
                objdata);
            // no parameters
        }
        { // For ./IDENT/display-time-text
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-time-text",
        ...
        { // For ./IDENT/display-time-dec
            ...
            obj = refda_register_ident(
                adm,
                cace_amm_obj_id_withenum("display-time-dec",
