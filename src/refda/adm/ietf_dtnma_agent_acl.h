 ...
 */
/// For ./TYPEDEF/tag
#define REFDA_ADM_IETF_DTNMA_AGENT_ACL_ENUM_OBJID_TYPEDEF_TAG 0
/// For ./TYPEDEF/permissions
#define REFDA_ADM_IETF_DTNMA_AGENT_ACL_ENUM_OBJID_TYPEDEF_PERMISSIONS 1
...
/// For ./TYPEDEF/result
#define REFDA_ADM_IETF_DTNMA_AGENT_ACL_ENUM_OBJID_TYPEDEF_RESULT 4
